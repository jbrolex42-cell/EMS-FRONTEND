...
export default function Hospitals() {
  ...
  useEffect(() => {
    ...
    // Comprehensive Kenya hospitals data (Levels 3–6)
    setHospitals([
      // ── NAIROBI COUNTY ──
      ...
      { _id: '28', name: 'Diani Beach Hospital',                      type: 'private',  level: 'level_5', county: 'Mombasa',     address: 'Diani, Kwale',                    phone: '040 3202000', shaEmpanelled: false, capabilities: { emergency: true, surgery: true, maternity: true } },
